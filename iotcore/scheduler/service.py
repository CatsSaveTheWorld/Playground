...
class AutomationService:
    ...
    def _enqueue_locked(
        ...
        if scheduled_for is not None:
            sequence_run, created = AutomationRun.objects.get_or_create(
    ...
    def update_device_state(cls, topic, payload):
        """Store the latest MQTT state without firing any automation."""
        return cls._update_device_state(topic, payload)
